...
//            },
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    var actionButton = '';
                    if (status === 1) {
                        actionButton = '<a href="/getvieworderdetail/' + data + '" class="btn btn-primary"><i class="fa fa-wrench"></i> Setup</a>';
                    }  else {
                        actionButton = '-';
                    }
                    return actionButton;
...
function saveapplicationdetails(Id) {
    $.ajax({
        ...
        success: function (response) {
        	...
        	$("#requestordetailsstatus").html("<span id=\"setupstatus\" class=\"label label-warning\" style=\"background-color: #28a745; color: white; font-size: 12px;\">Completed</span>");
            ...
            $.ajax({
                ...
                success: function (response) {
                	...
                	$('.validationdocsubmitbutton').hide();
                	   ...
                	   $('#validationDocumentsStatus').css('background-color', '#28a745').text("Completed");
                	   if(type === "1"){
	  ...
	  $.ajax({
          ...
          success: function (data) {
        	  displayValidationMessage("certificatedetails details saved successfully");        	  
        		...
        		$('#certificatedetailsstatus').css('background-color', '#28a745').text("Completed");
	        ...
	        success: function(response) {
	            ...
	            $("#validateCSR").hide();
	         	...
	         	$("#editrcsrButton").show();
	           	$("#saveCsrButton").hide();
	          	$("#validateButton").hide();
	          	$('#uploadCsrStatus').css('background-color', '#28a745').text("Completed");
